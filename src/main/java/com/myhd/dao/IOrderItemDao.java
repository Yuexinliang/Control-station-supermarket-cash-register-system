...
/**
 * className IOrderItemDao 订单项Dao层接口
 * packageName com.myhd.dao
 * Description IOrderItemDao
 *
 * @author huian
 * @version 1.0
...
public interface IOrderItemDao {
     ...
     * @return java.lang.Integer 返回更新时对订单项表影响的行数, 一般都是为1
    ...
    /**
     * Description: selectOrderItem 根据订单编号和商品编号查询唯一订单项
    ...
    /**
     * @description: 根据产品id查询该产品销售详情
     * @return: java.util.List<com.mod.pojo.OrderItem>
     * @author CYQH
     * @date: 2023/08/22 9:12
     */
    List<OrderItem> selectByProductId(Product product);
}
